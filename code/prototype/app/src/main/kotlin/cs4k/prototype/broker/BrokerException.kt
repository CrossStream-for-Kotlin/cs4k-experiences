...
sealed class BrokerException(msg: String) : Exception(msg) {
     ...
     */
    class BrokerDbConnectionException : BrokerException(BROKER_DB_CONNECTION_EXCEPTION_MESSAGE)

    /**
     * Exception indicating that the broker lost connection to the database.
     */
    class BrokerDbLostConnectionException : BrokerException(BROKER_DB_LOST_CONNECTION_EXCEPTION_MESSAGE)
    ...
    companion object {
        ...
        const val BROKER_DB_CONNECTION_EXCEPTION_MESSAGE = "Connection to the database could not be established"
        const val BROKER_DB_LOST_CONNECTION_EXCEPTION_MESSAGE = "Lost connection to the database"
    }
}
